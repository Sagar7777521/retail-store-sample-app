...
- [Cleanup](https://github.com/Sagar7777521/retail-store-sample-app/blob/main/README.md#step-12-cleanup)
...
3. **Clone Repository**: `git clone https://github.com/Sagar7777521/retail-store-sample-app.git`
...
```sh
git clone https://github.com/Sagar7777521/retail-store-sample-app.git
```
...
- **Issues**: [GitHub Issues](https://github.com/Sagar7777521/retail-store-sample-app/issues)
